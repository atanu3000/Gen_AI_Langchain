...
class Review(TypedDict):
    key_themes: Annotated[str, "The main themes of the review, e.g. 'performance', 'battery life', 'camera'"]
    summary: Annotated[str, "A brief summary of the review, no more than 20 words"]
...
# result = structured_model.invoke("""The hardware is great but the software feels bloted. There are too many preinstalled apps that I can't remove. Also, the UI looks outdated compared to other brands. Hopoing for a software update to fix these issues.""")
